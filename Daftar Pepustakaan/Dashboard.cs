...
namespace Daftar_Pepustakaan
{
    public partial class Dashboard : Form
    {
        ...
        public void Tampil(string valueToSearch)
        {
            ...
            dataGridView1.Columns[5].HeaderText = "Waktu Pembelian";
        ...
        {
            MySqlScript script = new MySqlScript(connection, "SET @id := 0; UPDATE data_buku SET id = @id := (@id+1); " +
                "ALTER TABLE data_buku AUTO_INCREMENT = 1;");
            script.Execute();
        }
